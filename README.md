# Dynamic Procedural Mesh Plugin
...
1. Copy the plugin files into `<YourProject>/Plugins/DynamicProceduralMesh`
...
2. Search for "Dynamic Mesh Actor" in the search bar to filter the actors
3. Drag and drop the `Dynamic Mesh Actor` into your level
